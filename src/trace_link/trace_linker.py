...
class TraceLinker:
    ...
    def load_pytorch_et(self, pytorch_et_file: str) -> List[PyTorchOperator]:
        ...
        # pytorch_ops = self.extract_pytorch_ops(all_nodes)
    ...
    def map_pytorch_to_kineto_ops(
        ...
        self.logger.debug(f"wxftest: link_ops, kineto_rf_id_to_kineto_op_map: {kineto_rf_id_to_kineto_op_map}")
        ...
        self.logger.debug(f"wxftest: self.pytorch_op_id_to_kineto_ops_map: {pytorch_op_id_to_kineto_ops_map}")
        self.logger.debug(f"wxftest: self.pytorch_op_id_to_exclusive_dur_map: {pytorch_op_id_to_exclusive_dur_map}")
